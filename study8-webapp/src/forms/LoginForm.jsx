...
import {callApi} from "../utils/ApiService.jsx";
...
const LoginForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (result.statusCode === 200) {
            ...
            setTimeout(() => setErrorMessage(""), TOAST_TIMEOUT);
        }
    };
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                className="w-full bg-[#0508A4] hover:bg-blue-700 text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Sign in
                            </button>
